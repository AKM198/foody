    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 fw-bold">Edit News Article</h1>
                    <p class="text-muted">Update news article</p>
                </div>
                ...
                <div class="card-body p-5">
                    <form action="{{ route('admin.news.update', $news) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{ old('image', $news->image) }}" placeholder="e.g., post-thumbnail-1.jpg">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <form action="{{ route('admin.news.destroy', $news) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this article?')">
                                @csrf
                                @method('DELETE')
